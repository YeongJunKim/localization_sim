...
h_main.dist1(x,y,theta,v_l,v_theta) = norm([x y]'-anchors_pos(:,1));
h_main.dist2(x,y,theta,v_l,v_theta) = norm([x y]'-anchors_pos(:,2));
h_main.dist3(x,y,theta,v_l,v_theta) = norm([x y]'-anchors_pos(:,3));
h_main.dist4(x,y,theta,v_l,v_theta) = norm([x y]'-anchors_pos(:,4));
