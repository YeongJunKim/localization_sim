...
annotation('textbox',...
    [0.381428571428571 0.900538461538462 0.001 0.001],'String',{'A'},...
    'FontSize',13,...
    'FitBoxToText','off');
...
annotation('line',[0.34714 0.34714],...
    [0.920538461538462 0.123076923076923],'LineWidth', 1, 'Color', [0 0 0]);

annotation('line',[0.789997142857143 0.789997142857143],...
    [0.922076923076923 0.124615384615384],'Color',[0 0 0],'LineWidth',1);


annotation('line',[0.742854285714286 0.742854285714286],...
    [0.920538461538462 0.123076923076923],'Color',[0 0 0],'LineWidth',1);


annotation('line',[0.704282857142857 0.704282857142857],...
    [0.923615384615385 0.126153846153846],'Color',[0 0 0],'LineWidth',1);


annotation('line',[0.385711428571429 0.385711428571429],...
    [0.922076923076923 0.124615384615384],'Color',[0 0 0],'LineWidth',1);
