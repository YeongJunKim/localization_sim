function app_gazebo_get_data_timer(obj, event)
global app ROBOTS
...
if isempty(first_run)
    ...
    for i = 1:app.agent_num
        ...
        % real_position
        app.experiment_data(i).real_position = zeros(app.nx, []);
...
%     a = toc;
    ...
    app.experiment_data(i).real_position(:,step) = [ROBOTS{i}.x ROBOTS{i}.y ROBOTS{i}.theta]';
